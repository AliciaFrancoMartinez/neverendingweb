...
<div id="map-stage" aria-label="Mapa panorámico interactivo">
  <div id="map-pan">
    <section class="map-tile" aria-hidden="false">
      ...
      <button class="marker congress" aria-label="Tokyo Congress" data-lat="30.6762" data-lon="130.6503">
        <span class="dot" aria-hidden="true">
          <span class="marker-letter">C</span>
        </span>
        <span class="tip tip-congress">
          <span class="tip-congress-entry">
            <img src="assets/logo_assc.png" alt="ASSC logo" class="tip-congress-logo">
            <strong class="tip-title">ASSC 2024 - Tokyo</strong>
            <span class="tip-institution">Poster</span>
      ...
      <button class="marker congress" aria-label="Teruel Congress" data-lat="34.3456" data-lon="-22.1065">
        <span class="dot" aria-hidden="true">
          <span class="marker-letter">C</span>
        </span>
        <span class="tip tip-congress">
          <span class="tip-congress-entry">
            <img src="assets/logo_aemcco.png" alt="AEMCCO logo" class="tip-congress-logo">
            <strong class="tip-title">AEMCCO 2022 - Teruel</strong>
            <span class="tip-institution">Oral Communication</span>
            <em class="tip-supervisor">How to measure and model awareness in visual search tasks?</em>
            <span class="tip-institution">Simposium Presentation</span>
            <em class="tip-supervisor">I've done the science, now how do I tell it?: from scientific conferences to social networks.</em>
          </span>
        </span>
      </button>

      <button class="marker congress" aria-label="Heraklion Congress" data-lat="28.3387" data-lon="5.1442">
        <span class="dot" aria-hidden="true">
          <span class="marker-letter">C</span>
        </span>
        <span class="tip tip-congress">
          <span class="tip-congress-entry">
            <img src="assets/logo_assc.png" alt="ASSC logo" class="tip-congress-logo">
            <strong class="tip-title">ASSC 2025 - Heraklion</strong>
            <span class="tip-institution">Oral Communication</span>
      ...
      <button class="marker congress" aria-label="Sevilla Congress" data-lat="30.3891" data-lon="-27.9845">
        <span class="dot" aria-hidden="true">
          <span class="marker-letter">C</span>
        </span>
        <span class="tip tip-congress">
          <span class="tip-congress-entry">
            ...
            <span class="tip-institution">Best Early-Career Researcher Award</span>
            <em class="tip-supervisor">¿“El aprendizaje probabilístico es inconsciente”? Modelando mucho ruido y poca muestra</em>
          </span>
        </span>
      </button>

      <button class="marker congress" aria-label="Tenerife Congress" data-lat="20.4636" data-lon="-40.2518">
        <span class="dot" aria-hidden="true">
          <span class="marker-letter">C</span>
        </span>
        <span class="tip tip-congress">
          <span class="tip-congress-entry">
            ...
            <span class="tip-institution">Oran Communication</span>
            <em class="tip-supervisor">Choose your own PAS? Studying the validity of the Perceptual Awareness Scale</em>
          </span>
        </span>
      </button>

      <button class="marker congress" aria-label="Utrecht Congress" data-lat="45.7074" data-lon="-14.8">
        <span class="dot" aria-hidden="true">
          <span class="marker-letter">C</span>
        </span>
        <span class="tip tip-congress">
          <span class="tip-congress-entry">
            <img src="assets/logo_multilevel.png" alt="Conference logo" class="tip-congress-logo">
      ...
      <button class="marker congress" aria-label="London Congress" data-lat="46.2074" data-lon="-18.9278">
        <span class="dot" aria-hidden="true">
          <span class="marker-letter">C</span>
        </span>
        <span class="tip tip-congress">
          <span class="tip-congress-entry">
            <img src="assets/logo_eps.jpg" alt="EPS logo" class="tip-congress-logo">
            <strong class="tip-title">EPS 2024 - London</strong>
            <span class="tip-institution">Oral Communication</span>
